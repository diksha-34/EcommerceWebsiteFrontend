  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Full Nelson', id: 'nelson' },
            { name: 'My Way', id: 'way' },
            { name: 'Re-Arranged', id: 'arranged' },
...
export default function Navigation() {
  ...
  const handleCategoryClick = (categories, sections, items, close) => {
    navigate(`${categories.id}/${sections.id}/${items.id}`);
    close();
  };
