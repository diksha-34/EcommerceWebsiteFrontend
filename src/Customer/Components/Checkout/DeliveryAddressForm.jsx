  ...
  return (
    <div>
      <Grid container spacing={4}>
        <Grid xs={12} lg={5} className="rounded-e-md shadow-md border h-[30.5rem] overflow-y-scroll">
          ...
          <Box className="border rounded-s-md shadow-md p-5">
            <form onSubmit={handleSubmit}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField required id="state" name="state" label="State/Provision/Region" fullWidth autoComplete="given-name"/>
                </Grid>
                <Grid item xs={12} sm={6}>
