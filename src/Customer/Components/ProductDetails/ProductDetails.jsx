    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500  '>3840 Reviews</p>
              </div>
            </div>
            ...
            <form className="mt-10">
              ...
              <Button onClick={handleAddCart} variant="contained" sx={{px:"2rem", py:"1rem", bgcolor:"#9155fd", my:"2rem"}}>Add to Cart</Button>
            </form>
          </div>
            ...
            <Grid container spacing={7}>
                ...
                <Grid item xs={5}>
                    ...
                    <div className="flex space-x-3">
                      ...
                      <p className='opacity-60'>54332 Ratings</p>
                    </div>
        ...
        <section className="pt-10">
          <h1 className='text-xl font-bold py-5'>Semilar Products</h1>
