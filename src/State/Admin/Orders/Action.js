...
export const confirmOrder=(orderId)=>async(dispatch)=>{
    ...
    try {
        ...
        dispatch({type:CONFIRMED_ORDERS_FAILURE, error:error.message})
    }
}
...
export const shipOrder=(orderId)=>async(dispatch)=>{
    ...
    try {
        ...
        dispatch({type:SHIP_ORDERS_FAILURE, error:error.message})
    }
}
...
export const deliveredOrder=(orderId)=>async(dispatch)=>{
    ...
    try {
        ...
        dispatch({type:DELIVERED_ORDERS_FAILURE, error:error.message})
    }
}
...
export const deleteOrder=(orderId)=>async(dispatch)=>{
    ...
    try {
        ...
        dispatch({type:DELETE_ORDERS_FAILURE, error:error.message})
    }
}
